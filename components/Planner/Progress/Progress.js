...
export const Progress = ({ data }) => {
  ...
  return (
    <div className={css.wrapper}>
      <Stage nr={1} data={stageData && stageData[0]} />
      <Stage nr={2} data={stageData && stageData[1]} />
      <Stage nr={3} data={stageData && stageData[2]} />
      <Stage nr={4} data={stageData && stageData[3]} />
    </div>
  );
};
...
const CircleDiagram = ({ completion }) => {
  return completion === 100 ? (
    ...
    <div className={css.circleDiagram}>
      ...
      <Diagram size="100%" factor={1 - completion / 100} strokeWidth={20} />
    </div>
  ) : completion === 0 ? (
    //NOT STARTED
    <div className={css.circleDiagram}>
